...
mei.vars <- c(1, paste("s(", mei.vars, ", k = 6)", sep = ""), paste("s(latitude , longitude, by = ", mei.vars, ")", sep = ""))
dis.vars <- c(1, paste("s(", dis.vars, ", k = 6)", sep = ""), paste("s(latitude , longitude, by = ", dis.vars, ")", sep = ""))
wind.vars <- c(1, paste("s(", uwind.vars, ", k = 6) + ","s(", vwind.vars, ", k = 6)", sep = ""), paste("s(latitude , longitude, by = ", uwind.vars, ") + ", "s(latitude , longitude, by = ", vwind.vars, ")", sep = ""))
...
write.csv(results, file = "bam_model_selection_all_combinations_6_knots.csv")
