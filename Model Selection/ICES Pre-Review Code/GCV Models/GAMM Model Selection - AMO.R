...
amo.bam.lag.0=bam(relative.condition~ s(longitude,latitude) + s( amo) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.1=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.1)  + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.2=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.2) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.3=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.3) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.4=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.4) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.5=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.5) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.6=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.6) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.7=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.7)  + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.8=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.8) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.9=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.9) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.10=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.10) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.11=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.11) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.lag.12=bam(relative.condition~ s(longitude,latitude) + s( amo.lag.12) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )


# without locations
amo.bam.wol.lag.0=bam(relative.condition~  s( amo) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.1=bam(relative.condition~  s( amo.lag.1)  + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.2=bam(relative.condition~  s( amo.lag.2) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.3=bam(relative.condition~  s( amo.lag.3) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.4=bam(relative.condition~  s( amo.lag.4) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.5=bam(relative.condition~  s( amo.lag.5) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.6=bam(relative.condition~  s( amo.lag.6) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.7=bam(relative.condition~  s( amo.lag.7)  + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.8=bam(relative.condition~  s( amo.lag.8) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.9=bam(relative.condition~  s( amo.lag.9) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.10=bam(relative.condition~  s( amo.lag.10) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.11=bam(relative.condition~  s( amo.lag.11) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )

amo.bam.wol.lag.12=bam(relative.condition~  s( amo.lag.12) + s(month, k = 6) + factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "GCV.Cp", family = Gamma(link = "log") )
...
save(bam_Model_Selection_AMO_Results, file = "bam_Model_Selection_AMO_Results.RData")
