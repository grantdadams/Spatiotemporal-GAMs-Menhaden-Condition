...
base.bam=bam(relative.condition~  s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log"))

spatially.explicit.bam=bam(relative.condition~ s(longitude,latitude) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log"))

#################################
# meis
#################################
# Non-spatially dependent 
mei.bam.lag.0=bam(relative.condition~ s(longitude,latitude) + s( mei) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.1=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.1)  + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.2=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.2) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.3=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.3) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.4=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.4) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.5=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.5) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.6=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.6) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.7=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.7)  + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.8=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.8) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.9=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.9) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.10=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.10) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.11=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.11) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.lag.12=bam(relative.condition~ s(longitude,latitude) + s( mei.lag.12) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )


# without locations
mei.bam.wol.lag.0=bam(relative.condition~  s( mei) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.1=bam(relative.condition~  s( mei.lag.1)  + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.2=bam(relative.condition~  s( mei.lag.2) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.3=bam(relative.condition~  s( mei.lag.3) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.4=bam(relative.condition~  s( mei.lag.4) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.5=bam(relative.condition~  s( mei.lag.5) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.6=bam(relative.condition~  s( mei.lag.6) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.7=bam(relative.condition~  s( mei.lag.7)  + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.8=bam(relative.condition~  s( mei.lag.8) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.9=bam(relative.condition~  s( mei.lag.9) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.10=bam(relative.condition~  s( mei.lag.10) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.11=bam(relative.condition~  s( mei.lag.11) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )

mei.bam.wol.lag.12=bam(relative.condition~  s( mei.lag.12) + s(month, k =6) + factor(year), data= df.menhaden, method = "ML", family = Gamma(link = "log") )
...
bam_Model_Selection_MEI_Results <- data.frame( model_name = names , deviance_explained = de, AIC = aic, Delta_AIC = daic, AIC_weight = waic, sample_size = sample_size)

save(bam_Model_Selection_MEI_Results, file = "bam_Model_Selection_MEI_Results_ML.RData")
