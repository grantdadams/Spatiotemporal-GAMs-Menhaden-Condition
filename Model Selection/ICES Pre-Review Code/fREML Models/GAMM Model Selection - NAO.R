...
base.bam=bam(relative.condition~  s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log"))

spatially.explicit.bam=bam(relative.condition~ s(longitude,latitude) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log"))

#################################
# nao
#################################
# Non-spatially dependent 
nao.bam.lag.0=bam(relative.condition~ s(longitude,latitude) + s( nao) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.1=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.1)  + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.2=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.2) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.3=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.3) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.4=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.4) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.5=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.5) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.6=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.6) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.7=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.7)  + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.8=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.8) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.9=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.9) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.10=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.10) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.11=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.11) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.lag.12=bam(relative.condition~ s(longitude,latitude) + s( nao.lag.12) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )


# without locations
nao.bam.wol.lag.0=bam(relative.condition~  s( nao) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.1=bam(relative.condition~  s( nao.lag.1)  + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.2=bam(relative.condition~  s( nao.lag.2) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.3=bam(relative.condition~  s( nao.lag.3) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.4=bam(relative.condition~  s( nao.lag.4) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.5=bam(relative.condition~  s( nao.lag.5) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.6=bam(relative.condition~  s( nao.lag.6) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.7=bam(relative.condition~  s( nao.lag.7)  + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.8=bam(relative.condition~  s( nao.lag.8) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.9=bam(relative.condition~  s( nao.lag.9) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.10=bam(relative.condition~  s( nao.lag.10) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.11=bam(relative.condition~  s( nao.lag.11) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )

nao.bam.wol.lag.12=bam(relative.condition~  s( nao.lag.12) + s(month, k = 6)+ factor(year) + s(vessel, bs = "re") , data= df.menhaden, method = "ML", family = Gamma(link = "log") )
...
save(bam_Model_Selection_NAO_Results, file = "bam_Model_Selection_NAO_Results_ML.RData")
