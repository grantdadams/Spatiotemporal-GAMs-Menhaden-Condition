...
river.bam.lag.1=bam(relative.condition~ s(longitude,latitude) + s( individual.monthly.miss.lag1.scaled)  + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )

river.bam.lag.2=bam(relative.condition~ s(longitude,latitude) + s( individual.monthly.miss.lag2.scaled) + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )

river.bam.lag.3=bam(relative.condition~ s(longitude,latitude) + s( individual.monthly.miss.lag3.scaled) + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )

river.bam.spring=bam(relative.condition~ s(longitude,latitude) + s(mean.monthly.March.to.May.miss.scaled) + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )

river.bam.winter=bam(relative.condition~ s(longitude,latitude) + s(miss.discharge.Nov.to.March.scaled) + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )


#########################
# Without location
# Non-spatially dependent 
river.bam.lag.0.wol=bam(relative.condition~ s( individual.monthly.miss.scaled) + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )

river.bam.lag.1.wol=bam(relative.condition~ s( individual.monthly.miss.lag1.scaled)  + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )

river.bam.lag.2.wol=bam(relative.condition~ s( individual.monthly.miss.lag2.scaled) + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )

river.bam.lag.3.wol=bam(relative.condition~ s( individual.monthly.miss.lag3.scaled) + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )

river.bam.spring.wol=bam(relative.condition~ s(mean.monthly.March.to.May.miss.scaled) + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )

river.bam.winter.wol=bam(relative.condition~ s(miss.discharge.Nov.to.March.scaled) + s(month, k = 6) + factor(year), data= df.menhaden, method = "fREML", family = Gamma(link = "log") )
