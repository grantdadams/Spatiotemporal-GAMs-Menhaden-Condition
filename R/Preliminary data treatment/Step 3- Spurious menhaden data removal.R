...
# ##### 
# #####
# data.frame.menhaden=read.csv("Data\\NMFS Menhaden survey data set 1964-2011 with location.csv")
...
# Coastline
coastline<- readShapePoly("Data\\US Coastline Shapefiles\\GSHHS_f_L1.shp")
poly.cut<- crop(coastline, poly)

# Depth data
depth<-raster("Data\\GEBCO depth data\\GEBCO2014_-98.9743_17.5321_-78.7179_31.9552_30Sec_Geotiff.tif")
...
# write.csv(data.frame.menhaden, file= "Data\\NMFS Menhaden survey data set 1964-2011 with location step 3.csv" )
